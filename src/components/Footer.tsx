          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            >
              ...
              >
                ...
                <span className="relative z-20">
                  {language === 'en' ? translations.footer.getInTouch : translations.footer.getInTouch}
                </span>
              </a>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2">
                ...
                <li className="text-gray-600 dark:text-gray-300">
                  <a href="tel:+221784634040" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    +221 78 463 40 40
                  </a>
                </li>
              </ul>
