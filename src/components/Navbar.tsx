...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-gray-100/90 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200/20 dark:border-gray-900/100 z-50" role="navigation" aria-label="Main navigation">
